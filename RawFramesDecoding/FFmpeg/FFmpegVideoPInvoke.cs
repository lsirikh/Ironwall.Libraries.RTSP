...
namespace Ironwall.Libraries.RTSP.RawFramesDecoding.FFmpeg
{
    ...
    static class FFmpegVideoPInvoke
    {
        ...
        [DllImport(LibraryName, CharSet = CharSet.Auto, EntryPoint = "create_video_decoder", CallingConvention = CallingConvention.Cdecl)]
        public static extern int CreateVideoDecoder(FFmpegVideoCodecId videoCodecId, out IntPtr handle);

        [DllImport(LibraryName, CharSet = CharSet.Auto, EntryPoint = "remove_video_decoder", CallingConvention = CallingConvention.Cdecl)]
        public static extern void RemoveVideoDecoder(IntPtr handle);

        [DllImport(LibraryName, CharSet = CharSet.Auto, EntryPoint = "set_video_decoder_extradata",
            CallingConvention = CallingConvention.Cdecl)]
        public static extern int SetVideoDecoderExtraData(IntPtr handle, IntPtr extradata, int extradataLength);

        [DllImport(LibraryName, CharSet = CharSet.Auto, EntryPoint = "decode_video_frame", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(LibraryName, CharSet = CharSet.Auto, EntryPoint = "scale_decoded_video_frame", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(LibraryName, CharSet = CharSet.Auto, EntryPoint = "create_video_scaler", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(LibraryName, CharSet = CharSet.Auto, EntryPoint = "remove_video_scaler", CallingConvention = CallingConvention.Cdecl)]
